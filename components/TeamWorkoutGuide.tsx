...
export default function TeamWorkoutGuide() {
    return (
        <div className="text-text-primary dark:text-dark-text-primary">
            ...
            <Section title="Communication is Key" defaultOpen={true}>
            ...
            <Section title="Play to Your Strengths">
            ...
            <Section title="Team Size Strategy: Pairs vs. Quads">
            ...
            <Section title="Stepping Up for Competition">
            ...
            <Section title="Master Your Transitions">
            ...
            <Section title="Pace it Right: The Golden Rule">
            ...
            <Section title="Stay Positive & Lift Each Other Up">
