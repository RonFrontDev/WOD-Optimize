...
import { ArrowLeftIcon, SparklesIcon, ExclamationTriangleIcon, ShieldCheckIcon, ForwardIcon } from './Icons';
import LoadingSpinner from './LoadingSpinner';
import type { AdaptiveWorkoutStrategy, MovementModification } from '../types';
...
export default function AdaptiveWorkoutBuilder({ onBack }: AdaptiveWorkoutBuilderProps): React.JSX.Element {
    ...
    const handleGenerateStrategy = useCallback(async () => {
        ...
        try {
            const result = await generateAdaptiveStrategy(workoutDescription, injuryDescription);
            if (result) {
                setStrategy(result);
            } else {
    ...
    }, [workoutDescription, injuryDescription]);
